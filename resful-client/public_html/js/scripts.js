...
function initWowdow() {
    ...
    $(window).resize(function() {
        a();
		var nh = $(".nav-holder");
		  if (!nh.hasClass("vis-x") && $(window).width() > 1036)  {nh.css("display","block");}
		  else {nh.css("display","none");}
    });
    ...
    nb.on("click", function() {
        ...
        if ($(this).hasClass("vis-m") || $(this).hasClass("vis-x")) showMenu(); else hideMenu();
